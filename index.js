...
var mongodb, MongoClient, db, collection, config, _, async, request, Job, Queue, updateConfig, createJob, createBatch, args, queues, express, app, bodyParser, router;
...
Queue = (function(){
  ...
  prototype.processPendingJobs = function(){
    ...
    collection.findAndModify(query, [['priority', 'desc']], {
      $set: {
        state: 'processing'
      }
    }, {
